...
public class GameManager implements Disposable {
    ...
    public static final String[] purpleDying = { "purpleDying01", "purpleDying02", "purpleDying03", "purpleDying04" };

    // Ballon Enemy Render
    public static final String[] BALLON_DYING_REGION_NAMES = new String[] { "ballomDying", pinkDying[0], pinkDying[1],
    ...
    // Doll Enemy Render
    public static final String[] DOLL_DYING_REGION_NAMES = new String[] { "dollDying", purpleDying[0], purpleDying[1],
    ...
    // Pontan Enemy Render
    public static final String[] PONTAN_DYING_REGION_NAMES = new String[] { "pontanDying", pinkDying[0], pinkDying[1],
            pinkDying[2], pinkDying[3] };
    ...
    /* Speed of each enemy */
    public static final float ENEMY_SLOWEST_SPEED = 0f;
