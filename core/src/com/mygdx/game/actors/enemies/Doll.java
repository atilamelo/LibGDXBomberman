...
public class Doll extends Enemy {
    ...
    public Doll(Body body) {
        super(body, EnemyConfig.dollConfig);
        ...
        for (String path : GameManager.DOLL_LEFT_REGION_NAMES) {
        ...
        for (String path : GameManager.DOLL_RIGHT_REGION_NAMES) {
        ...
        for (String path : GameManager.DOLL_DYING_REGION_NAMES) {
