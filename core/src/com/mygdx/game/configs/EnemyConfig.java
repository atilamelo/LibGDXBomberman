...
public class EnemyConfig {
        ...
        public EnemyConfig(int hp, float speed, short[] maskBits, short maskBitsBody, float intersectionChangeChance,
                        int rangePursue,
                        String[] leftAnimation, String[] rightAnimation, String[] dyingAnimation) {
                this.hp = hp;
                this.speed = speed;
                this.maskBits = maskBits;
                this.maskBitsBody = maskBitsBody;
        ...
        public final static EnemyConfig ballonConfig = new EnemyConfig(
                        ...
                        GameManager.MASK_BITS_DEFAULT_ARRAY,
                        GameManager.MASK_BITS_DEFAULT,
        ...
        public String toString() {
                return "EnemyConfig [hp=" + hp + ", speed=" + speed + ", maskBits=" + Arrays.toString(maskBits)
                                + ", maskBitsBody=" + maskBitsBody + ", intersectionChangeChance="
                                + intersectionChangeChance
                                + ", rangePursue=" + rangePursue + ", leftAnimation=" + Arrays.toString(leftAnimation)
                                + ", rightAnimation=" + Arrays.toString(rightAnimation) + ", dyingAnimation="
                                + Arrays.toString(dyingAnimation) + "]";
        }
